...
export class AuthenticationClient extends AuthorizedApiBase {
    ...
    getInfo(): Promise<AuthenticationInfo> {
    ...
    protected processGetInfo(response: Response): Promise<AuthenticationInfo> {
        ...
        return Promise.resolve<AuthenticationInfo>(null as any);
    }
    ...
    loginOidc(): Promise<FileResponse> {
        let url_ = this.baseUrl + "/auth/login/oidc";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processLoginOidc(_response);
        });
    }

    protected processLoginOidc(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
    ...
    confirmEmail(userId?: string | undefined, token?: string | undefined): Promise<FileResponse> {
    ...
    sendConfirmationEmail(username?: string | undefined): Promise<FileResponse> {
...
export class FileClient extends AuthorizedApiBase {
    ...
    get(directory: string, name: string, mimeType?: string | undefined, param?: string | null | undefined): Promise<FileResponse> {
        let url_ = this.baseUrl + "/files/{directory}/{name}?";
        if (directory === undefined || directory === null)
            throw new globalThis.Error("The parameter 'directory' must be defined.");
        ...
        if (mimeType === null)
            throw new globalThis.Error("The parameter 'mimeType' cannot be null.");
...
export class ProjectClient extends AuthorizedApiBase {
    ...
    inviteParticipant(projectId: string, participantName?: string | undefined): Promise<UserDto> {
        let url_ = this.baseUrl + "/projects/{projectId}/inviteParticipant?";
        if (projectId === undefined || projectId === null)
            throw new globalThis.Error("The parameter 'projectId' must be defined.");
        url_ = url_.replace("{projectId}", encodeURIComponent("" + projectId));
        if (participantName === null)
            throw new globalThis.Error("The parameter 'participantName' cannot be null.");
    ...
    removeParticipant(projectId: string, participantName?: string | undefined): Promise<FileResponse> {
...
export class TicketClient extends AuthorizedApiBase {
    ...
    setStatus(projectId: string, ticketId: number, status?: TicketStatus | undefined): Promise<FileResponse> {
...
export class UserClient extends AuthorizedApiBase {
    ...
    getPinnedProjects(): Promise<ProjectDto[]> {
        let url_ = this.baseUrl + "/user/pinnedProjects";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetPinnedProjects(_response);
        });
    }

    protected processGetPinnedProjects(response: Response): Promise<ProjectDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    setPinnedProjects(pinnedProjectIds: string[]): Promise<FileResponse> {
        let url_ = this.baseUrl + "/user/pinnedProjects";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(pinnedProjectIds);
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processSetPinnedProjects(_response);
        });
    }

    protected processSetPinnedProjects(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    acceptInvitationAndRedirect(projectId: string): Promise<FileResponse> {
        let url_ = this.baseUrl + "/user/invitations/{projectId}/accept";
        if (projectId === undefined || projectId === null)
            throw new globalThis.Error("The parameter 'projectId' must be defined.");
        url_ = url_.replace("{projectId}", encodeURIComponent("" + projectId));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processAcceptInvitationAndRedirect(_response);
        });
    }

    protected processAcceptInvitationAndRedirect(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
    ...
    declineInvitationAndRedirect(projectId: string): Promise<FileResponse> {
        let url_ = this.baseUrl + "/user/invitations/{projectId}/decline";
        if (projectId === undefined || projectId === null)
            throw new globalThis.Error("The parameter 'projectId' must be defined.");
        url_ = url_.replace("{projectId}", encodeURIComponent("" + projectId));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processDeclineInvitationAndRedirect(_response);
        });
    }

    protected processDeclineInvitationAndRedirect(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
...
export class OidcAuthentiationInfo implements IOidcAuthentiationInfo {
    ...
    constructor(data?: IOidcAuthentiationInfo) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.providerIconUrl = _data["providerIconUrl"];
            this.requireVerifiedEmail = _data["requireVerifiedEmail"];
        }
    }

    static fromJS(data: any): OidcAuthentiationInfo {
        data = typeof data === 'object' ? data : {};
        let result = new OidcAuthentiationInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["providerIconUrl"] = this.providerIconUrl;
        data["requireVerifiedEmail"] = this.requireVerifiedEmail;
        return data;
    }
}

export interface IOidcAuthentiationInfo {
    providerId: string;
    providerName: string;
    providerIconUrl?: string | undefined;
    requireVerifiedEmail?: boolean;
...
export class TicketDto implements ITicketDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.project = _data["project"] ? ProjectDto.fromJS(_data["project"]) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.assignees)) {
            ...
            for (let item of this.assignees)
                data["assignees"].push(item ? item.toJSON() : undefined as any);
        }
...
export class ProjectDto implements IProjectDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.description = _data["description"];
            this.author = _data["author"] ? UserDto.fromJS(_data["author"]) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.tickets)) {
            ...
            for (let item of this.tickets)
                data["tickets"].push(item ? item.toJSON() : undefined as any);
        }
        data["sorting"] = this.sorting;
        data["filter"] = this.filter;
        return data;
