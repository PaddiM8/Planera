...
export class FileClient extends AuthorizedApiBase {
    ...
    get(directory: string, name: string, mimeType: string, param?: string): Promise<FileResponse> {
        ...
        if (mimeType === undefined || mimeType === null)
            throw new Error("The parameter 'mimeType' must be defined and cannot be null.");
        else
...
export class ProjectClient extends AuthorizedApiBase {
    ...
    inviteParticipant(projectId: string, participantName: string): Promise<UserDto> {
        ...
        if (participantName === undefined || participantName === null)
            throw new Error("The parameter 'participantName' must be defined and cannot be null.");
        else
