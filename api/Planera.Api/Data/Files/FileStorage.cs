namespace Planera.Api.Data.Files;

class FileStorage(IConfiguration configuration) : IFileStorage
{
    private readonly string _baseDirectory = configuration["FileStorage:Path"]!;
