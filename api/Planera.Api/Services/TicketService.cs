    ...
    IFileStorage fileStorage)
{
        ...
        TicketFilter? filter = null)
    {
        ...
        if (username != null && slug != null)
        {
            // TODO: Do something similar for the overview page (the case where no username/slug combination is provided)
        ...
        return new TicketQueryResult(tickets, sorting.Value, filter.Value);
    }
