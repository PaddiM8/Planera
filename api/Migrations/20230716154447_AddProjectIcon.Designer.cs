...
namespace Planera.Migrations
{
    ...
    [Migration("20230716154447_AddProjectIcon")]
    partial class AddProjectIcon
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TicketUser", b =>
                {
                    ...
                    b.Property<int>("AssignedTicketsProjectId")
                        .HasColumnType("INTEGER");

                    b.HasKey("AssigneesId", "AssignedTicketsId", "AssignedTicketsProjectId");

                    b.HasIndex("AssignedTicketsId", "AssignedTicketsProjectId");
            ...
            modelBuilder.Entity("TicketUser", b =>
                {
                    ...
                    b.HasOne("Planera.Data.Ticket", null)
                        .WithMany()
                        .HasForeignKey("AssignedTicketsId", "AssignedTicketsProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
